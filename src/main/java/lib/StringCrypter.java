...
/**
 * Класс для шифрования и дешифрования строк Использует библиотеку Apache Codec
...
public class StringCrypter {
	...
	/**
	 * Упрощенный конструктор. Создает StringCrypter с ключом DESSecretKey со
	 * значением по умолчанию (не рекомендуется)
	 */
	...
	/**
	 * Упрощенный конструктор. Создает StringCrypter с ключом DESSecretKey
	 * (алгоритм шифрования DES) со значением key. Ключ key должен иметь длину 8
	 * байт
	 */
